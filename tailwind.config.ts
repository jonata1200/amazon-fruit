...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Cores baseadas em variáveis CSS (para dark mode dinâmico)
        ...
        // Cores semânticas adicionais do design system
        // Nota: Cores específicas estão definidas em src/lib/design-tokens/colors.ts
        // Para usar cores específicas, importe de '@/lib/design-tokens'
        success: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      // Espaçamento: Tokens definidos em src/lib/design-tokens/spacing.ts
      // Tailwind usa escala padrão que já está alinhada
      borderRadius: {
        lg: 'var(--radius)',
        md: 'calc(var(--radius) - 2px)',
        sm: 'calc(var(--radius) - 4px)',
      },
      // Transições baseadas em design tokens
      transitionDuration: {
        instant: '0ms',
        fast: '150ms',
        base: '200ms',
