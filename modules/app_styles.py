...
def get_stylesheet(theme_name='dark'):
    ...
    return f"""
        /* ... (Estilos de QWidget, QMainWindow, QFrame#NavFrame, etc. como antes) ... */
        ...
        /* --- NOVO ESTILO PARA BOTÕES DE AÇÃO --- */
        ...
        /* ... (Estilo do QLineEdit como antes) ... */
        QLineEdit {{
        ...
        /* --- SEPARAÇÃO DOS ESTILOS DO CABEÇALHO DA TABELA --- */
        ...
        /* ... (Estilos de QFrame#KPIFrame, etc. como antes) ... */
